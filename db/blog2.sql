...
--
-- Anamakine: localhost
-- Üretim Zamanı: 29 Eyl 2022, 23:32:04
...
CREATE TABLE `aboutme` (
  ...
  `metin` text CHARACTER SET utf8 COLLATE utf8_turkish_ci NOT NULL
...
CREATE TABLE `ayar` (
  `id` int(11) NOT NULL,
  `logo` varchar(250) CHARACTER SET utf8 COLLATE utf8_turkish_ci NOT NULL,
  `url` varchar(250) CHARACTER SET utf8 COLLATE utf8_turkish_ci NOT NULL,
  `baslik` varchar(100) CHARACTER SET utf8 COLLATE utf8_turkish_ci NOT NULL,
  `aciklama` text CHARACTER SET utf8 COLLATE utf8_turkish_ci NOT NULL,
  `anahtarkelime` varchar(200) CHARACTER SET utf8 COLLATE utf8_turkish_ci NOT NULL,
  `yazar` varchar(200) CHARACTER SET utf8 COLLATE utf8_turkish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
CREATE TABLE `kategoriler` (
  ...
  `detay` varchar(150) CHARACTER SET utf8 COLLATE utf8_turkish_ci NOT NULL,
...
CREATE TABLE `mail` (
  `id` int(11) NOT NULL,
  `smtphost` varchar(30) CHARACTER SET utf8 COLLATE utf8_turkish_ci NOT NULL,
  `smtpuser` varchar(250) CHARACTER SET utf8 COLLATE utf8_turkish_ci NOT NULL,
  `smtppassword` varchar(200) CHARACTER SET utf8 COLLATE utf8_turkish_ci NOT NULL,
...
CREATE TABLE `menu` (
  ...
  `link` varchar(250) CHARACTER SET utf8 COLLATE utf8_turkish_ci NOT NULL,
  `sira` int(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
CREATE TABLE `sayfalar` (
  ...
  `durum` varchar(1) CHARACTER SET utf8 COLLATE utf8_turkish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
CREATE TABLE `sosyal` (
  ...
  `ad` varchar(20) CHARACTER SET utf8 COLLATE utf8_turkish_ci NOT NULL,
  `link` varchar(250) CHARACTER SET utf8 COLLATE utf8_turkish_ci NOT NULL,
  `ikon` varchar(250) CHARACTER SET utf8 COLLATE utf8_turkish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
CREATE TABLE `user` (
  `id` int(11) NOT NULL,
  `kulladi` varchar(30) CHARACTER SET utf8 COLLATE utf8_turkish_ci NOT NULL,
  `kullpass` varchar(100) CHARACTER SET utf8 COLLATE utf8_turkish_ci NOT NULL,
...
INSERT INTO `user` (`id`, `kulladi`, `kullpass`, `adsoyad`) VALUES
(1, 'admin', '827ccb0eea8a706c4c34a16891f84e7b', 'Hakan');
...
CREATE TABLE `yazilar` (
  `id` int(11) NOT NULL,
  `baslik` varchar(150) CHARACTER SET utf8 COLLATE utf8_turkish_ci NOT NULL,
  `icerik` text CHARACTER SET utf8 COLLATE utf8_turkish_ci NOT NULL,
  `etiket` varchar(200) CHARACTER SET utf8 COLLATE utf8_turkish_ci NOT NULL,
